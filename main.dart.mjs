...
_1618: () => globalThis.removeSplashFromWeb(),
...
_1673: r => r.deref(),
_1674: c => new FinalizationRegistry(
            o => dartInstance.exports.$invokeCallback1(c, o)),
_1675: (r, v, t, d) => r.register(v, t, d),
_1678: Date.now,
...
_1711: () => Date.now(),
_1712: () => new XMLHttpRequest(),
_1713: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1714: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
...
_1743: (a, i) => a.push(i),
_1747: a => a.pop(),
_1748: (a, i) => a.splice(i, 1),
_1750: (a, s) => a.join(s),
_1751: (a, s, e) => a.slice(s, e),
_1754: a => a.length,
_1756: (a, i) => a[i],
_1757: (a, i, v) => a[i] = v,
_1759: a => a.join(''),
_1760: (o, a, b) => o.replace(a, b),
_1762: (s, t) => s.split(t),
...
_1908: (o, p) => o[p],
_1909: (o, p, v) => o[p] = v,
_1945: (x0,x1) => x0.withCredentials = x1,
_1947: x0 => x0.responseURL,
_1948: x0 => x0.status,
_1949: x0 => x0.statusText,
_1951: (x0,x1) => x0.responseType = x1,
_1952: x0 => x0.response,
_2031: x0 => x0.style,
_2506: (x0,x1) => x0.src = x1,
_2508: (x0,x1) => x0.srcdoc = x1,
_2513: (x0,x1) => x0.allow = x1,
_2525: x0 => x0.contentWindow,
_3768: () => globalThis.window,
_3846: x0 => x0.navigator,
_4219: x0 => x0.userAgent,
_4270: x0 => x0.data,
_7563: () => globalThis.document,
_8014: x0 => x0.id,
_8015: (x0,x1) => x0.id = x1,
_12433: (x0,x1) => x0.border = x1,
_12875: (x0,x1) => x0.height = x1,
_13565: (x0,x1) => x0.width = x1,
_14742: () => globalThis.window,
_14763: x0 => x0.matches,
_14767: x0 => x0.platform,
_14772: x0 => x0.navigator,
_14779: x0 => x0.status,
_14780: (x0,x1) => x0.responseType = x1,
_14782: x0 => x0.response,
_14786: () => globalThis.window.flutterCanvasKit
    };
