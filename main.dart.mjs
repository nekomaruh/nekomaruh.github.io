...
_1612: () => globalThis.removeSplashFromWeb(),
_1613: (x0,x1) => x0.matchMedia(x1),
_1624: x0 => new Array(x0),
_1627: (o, c) => o instanceof c,
...
_1666: o => new WeakRef(o),
_1667: r => r.deref(),
_1668: c => new FinalizationRegistry(
            o => dartInstance.exports.$invokeCallback1(c, o)),
_1669: (r, v, t, d) => r.register(v, t, d),
_1672: Date.now,
...
_1685: s => stringToDartString(JSON.stringify(stringFromDartString(s))),
_1686: s => printToConsole(stringFromDartString(s)),
_1688: () => globalThis.performance,
_1689: () => globalThis.JSON,
_1690: x0 => x0.measure,
_1691: x0 => x0.mark,
_1692: (x0,x1,x2,x3) => x0.measure(x1,x2,x3),
_1693: (x0,x1,x2) => x0.mark(x1,x2),
_1694: (x0,x1) => x0.parse(x1),
_1695: (o, t) => o instanceof t,
_1697: f => finalizeWrapper(f,x0 => dartInstance.exports._1697(f,x0)),
_1698: f => finalizeWrapper(f,x0 => dartInstance.exports._1698(f,x0)),
_1699: o => Object.keys(o),
_1700: (ms, c) =>
              setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
_1701: (handle) => clearTimeout(handle),
_1702: (ms, c) =>
          setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
_1703: (handle) => clearInterval(handle),
_1704: (c) =>
              queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
_1705: () => Date.now(),
_1706: () => new XMLHttpRequest(),
_1707: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1708: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_1709: (x0,x1) => x0.send(x1),
_1711: x0 => x0.getAllResponseHeaders(),
_1718: f => finalizeWrapper(f,x0 => dartInstance.exports._1718(f,x0)),
_1719: f => finalizeWrapper(f,x0 => dartInstance.exports._1719(f,x0)),
_1720: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
_1721: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
_1739: (a, i) => a.push(i),
_1743: a => a.pop(),
...
_1814: s => stringToDartString(stringFromDartString(s).toUpperCase()),
_1815: s => stringToDartString(stringFromDartString(s).toLowerCase()),
_1817: (s, m) => {
          try {
...
_1819: (x0,x1) => x0.test(x1),
_1820: (x0,x1) => x0.exec(x1),
_1821: (x0,x1) => x0.exec(x1),
_1822: x0 => x0.pop(),
_1826: (x0,x1,x2) => x0[x1] = x2,
_1828: o => o === undefined,
_1829: o => typeof o === 'boolean',
_1830: o => typeof o === 'number',
_1832: o => typeof o === 'string',
_1835: o => o instanceof Int8Array,
_1836: o => o instanceof Uint8Array,
_1837: o => o instanceof Uint8ClampedArray,
_1838: o => o instanceof Int16Array,
_1839: o => o instanceof Uint16Array,
_1840: o => o instanceof Int32Array,
_1841: o => o instanceof Uint32Array,
_1842: o => o instanceof Float32Array,
_1843: o => o instanceof Float64Array,
_1844: o => o instanceof ArrayBuffer,
_1845: o => o instanceof DataView,
_1846: o => o instanceof Array,
_1847: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_1849: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_1850: o => o instanceof RegExp,
_1851: (l, r) => l === r,
_1852: o => o,
_1853: o => o,
_1854: o => o,
...
_1856: o => o.length,
_1859: (o, i) => o[i],
_1860: f => f.dartFunction,
_1861: l => arrayFromDartList(Int8Array, l),
_1862: l => arrayFromDartList(Uint8Array, l),
_1863: l => arrayFromDartList(Uint8ClampedArray, l),
_1864: l => arrayFromDartList(Int16Array, l),
_1865: l => arrayFromDartList(Uint16Array, l),
_1866: l => arrayFromDartList(Int32Array, l),
_1867: l => arrayFromDartList(Uint32Array, l),
_1868: l => arrayFromDartList(Float32Array, l),
_1869: l => arrayFromDartList(Float64Array, l),
_1870: (data, length) => {
...
_1871: l => arrayFromDartList(Array, l),
_1872: stringFromDartString,
_1873: stringToDartString,
_1874: () => ({}),
_1875: () => [],
_1876: l => new Array(l),
_1877: () => globalThis,
...
_1904: (o, p) => o[p],
_1905: (o, p, v) => o[p] = v,
_1940: (x0,x1) => x0.withCredentials = x1,
_1943: x0 => x0.responseURL,
_1944: x0 => x0.status,
_1945: x0 => x0.statusText,
_1946: (x0,x1) => x0.responseType = x1,
_1948: x0 => x0.response,
_2026: x0 => x0.style,
_2514: (x0,x1) => x0.src = x1,
_2516: (x0,x1) => x0.srcdoc = x1,
_2521: (x0,x1) => x0.allow = x1,
_2534: x0 => x0.contentWindow,
_3705: () => globalThis.window,
_3785: x0 => x0.navigator,
_4266: x0 => x0.userAgent,
_4315: x0 => x0.data,
_8680: () => globalThis.document,
_9136: (x0,x1) => x0.id = x1,
_9137: x0 => x0.id,
_11962: (x0,x1) => x0.border = x1,
_12400: (x0,x1) => x0.height = x1,
_13088: (x0,x1) => x0.width = x1,
_14547: () => globalThis.window,
_14568: x0 => x0.matches,
_14572: x0 => x0.platform,
_14577: x0 => x0.navigator,
_14584: x0 => x0.status,
_14585: (x0,x1) => x0.responseType = x1,
_14587: x0 => x0.response,
_14591: () => globalThis.window.flutterCanvasKit
    };
